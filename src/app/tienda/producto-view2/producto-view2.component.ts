...
declare var $: any;
@Component({
  selector: 'app-producto-view2',
  templateUrl: './producto-view2.component.html',
  styleUrls: ['./producto-view2.component.scss']
})
export class ProductoView2Component implements OnInit {
    id:any;
    data:any = {
      listTestimonios: []
    };
